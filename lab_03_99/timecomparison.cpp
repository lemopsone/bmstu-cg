...
QBarSeries *TimeComparison::createSeries()
{
    ...
    measureTime(setDDA, setBresenhamInt, setBresenhamFloat, setBresenhamSmooth, setWu);

    return series;
}

void TimeComparison::measureTime(QBarSet *setDDA,
                                 ...
                                 QBarSet *setWu)
{
    ...
    *setDDA << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();

    start = std::chrono::high_resolution_clock::now();
    LineDrawer::BresenhamInt(p1, p2);
    end = std::chrono::high_resolution_clock::now();
    *setBresenhamInt << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();

    start = std::chrono::high_resolution_clock::now();
    LineDrawer::Bresenham(p1, p2);
    end = std::chrono::high_resolution_clock::now();
    *setBresenhamFloat << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();

    start = std::chrono::high_resolution_clock::now();
    LineDrawer::BresenhamSmooth(p1, p2);
    end = std::chrono::high_resolution_clock::now();
    *setBresenhamSmooth << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();

    start = std::chrono::high_resolution_clock::now();
    LineDrawer::Wu(p1, p2);
    end = std::chrono::high_resolution_clock::now();
    *setWu << std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
}
