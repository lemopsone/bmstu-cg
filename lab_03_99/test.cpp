...
Test::Test(QString name, QString desc, QList<LineData> lines,
           QList<SpectreData> spectres, QColor backgroundColor) {
  this->name_ = name;
  this->desc_ = desc;
  this->lines_ = lines;
...
QList<LineData> Test::lines() const { return this->lines_; }

QList<SpectreData> Test::spectres() const { return this->spectres_; }
