...
public:
  ...
  void addCircle(CircleData data);
  void addEllipse(EllipseData data);
  void addCircleSpectre(CircleData data, qreal step, qsizetype count);
  void addEllipseSpectre(EllipseData data, qreal step, qsizetype count);
